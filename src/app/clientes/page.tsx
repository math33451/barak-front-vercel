    ...
    },
    {
      ...
      render: (client) => (
        <div className="flex gap-2">
          <button onClick={() => openModal(client)} className="btn btn-sm btn-outline">
            <Edit className="h-4 w-4" />
          </button>
          <button onClick={() => handleDeleteClient(client.id)} className="btn btn-sm btn-outline btn-error">
