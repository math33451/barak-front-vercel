...
make_request "POST" "/rest/proposta" "$proposta1_data" "Criando proposta finalizada 1 (venda)"
make_request "POST" "/rest/proposta" "$proposta2_data" "Criando proposta finalizada 2 (venda)"
...
echo "   • Propostas: 3 (2 finalizadas = vendas, 1 pendente)"
echo ""
